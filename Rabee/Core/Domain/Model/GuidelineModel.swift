...
struct GuidelineModel {
    ...
    static let GuidelineData: [GuidelineModel] = [
        ...
        GuidelineModel(step: 2,title: "Pilih Suasana Warna", description: "Warna untuk dekorasi, bunga, pakaian, dan lainnya yang dapat mencerminkan suasana pernikahan.", state: .notFinished),
        GuidelineModel(step: 3,title: "Pilih Busana Pengantin", description: "Pakaian yang dikenakan oleh pengantin dan/atau tamu undangan dalam sebuah pernikahan.", state: .notFinished),
